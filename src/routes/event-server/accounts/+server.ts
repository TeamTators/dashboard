/**
 * @fileoverview Event server endpoint for account exports.
 * @description
 * Requires an API key and returns account data for event server consumers.
 */
...
/**
 * Returns all account records for the event server.
 * @param event - SvelteKit request event.
 * @returns A JSON response with account data or an auth error.
 */
