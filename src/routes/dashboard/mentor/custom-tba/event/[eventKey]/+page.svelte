<script lang="ts">
    ...
    let eventState: 'same_key' | 'finding' | 'found' | 'not_found' | 'invalid' = $state('same_key');
    ...
    const findEvent = (key: string) => {
        ...
        // text must match 20XX[ab][cd]
        if (!/^\d{4}[a-z]{2}[a-z]{2}$/.test(key)) {
            eventState = 'invalid';
            return;
        }
        eventState = 'finding';
    ...
    const submit = async () => {
        if (dateState === 'valid' && eventName.length >= 3 && (eventState === 'not_found' || eventState === 'same_key') && eventKey && year) {
...
<div class="container layer-1">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <a href="/dashboard/mentor/custom-tba/event/{event.tba.key}/matches" class="text-reset text-decoration-none">
        ...
        <div class="col-md-6">
            <a href="/dashboard/mentor/custom-tba/event/{event.tba.key}/teams" class="text-reset text-decoration-none">
                <div class="card bg-primary">
                    <div class="card-body">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="event-key-input" placeholder="2025idbo..." oninput={e => findEvent(e.currentTarget.value)} bind:value={eventKey}>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div>
                ...
                {:else if eventState === 'invalid'}
                    ...
                    <span class="text-warning">Invalid event key format. Please use the format 20XX[ab][cd].</span>
                {/if}   
            </div>
        </div>
    </div>
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="event-name-input" placeholder="Event Name" bind:value={eventName}>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="start-date-input" bind:value={start_date} oninput={validateEventDates}>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="end-date-input" class="form-label">End Date</label>
                    <input type="date" class="form-control" id="end-date-input" bind:value={end_date} oninput={validateEventDates}>
                </div>
            </div>
        </div>
        <div class="row mb-3">
