/**
 * @fileoverview Server loader for custom event match management.
 * @description
 * Ensures mentor access and loads event, matches, and teams for editing.
 */
...
/**
 * Loads match and team data for a custom event.
