					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<label for="max-velocity" class="form-label"
								>Max Velocity ({$app.maxVelocity} ft/s)</label
							>
							<input
								type="range"
								class="form-range"
						...
						<div class="col-lg-6 col-md-12">
							<label for="acceleration" class="form-label"
								>Acceleration ({$app.acceleration} ft/s²)</label
							>
							<input
								type="range"
								class="form-range"
						...
						<div class="col-lg-6 col-md-12">
							<label for="max-spin-speed" class="form-label"
								>Max Spin Speed ({$app.spinSpeed} deg/s)</label
							>
							<input
								type="range"
								class="form-range"
								...
								max="720"
								step="1"
								oninput={(e) => app.setConfig({ spinSpeed: Number(e.currentTarget.value) })}
							/>
						</div>
						<div class="col-lg-6 col-md-12">
							<label for="spin-acceleration" class="form-label"
								>Spin Acceleration ({$app.spinAcceleration} deg/s²)</label
							>
							<input
								type="range"
								class="form-range"
								...
								max="2000"
								step="1"
								oninput={(e) => app.setConfig({ spinAcceleration: Number(e.currentTarget.value) })}
							/>
						</div>
					</div>
				</div>
